...
<aside class="flex flex-col justify-between w-70 border-r-2 border-gray-200 bg-[#E5E6EE] pl-8 pt-10" style="height: 91vh">
    <!-- Top Navigation -->
    <div class="space-y-2 pt-4">

        <!-- Home -->
        <div class="flex items-center space-x-2 p-4 hover:bg-green-200 <?php echo ($module === 'home') ? 'bg-green-900 text-white' : 'text-[#0C4212]'; ?>">
        ...
        <!-- Products -->
        <div class="flex items-center space-x-2 p-4 hover:bg-green-200 <?php echo ($module === 'products') ? 'bg-green-900 text-white' : 'text-[#0C4212]'; ?>">
            <svg class="w-6 h-6" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="<?php echo ($module === 'products') ? 'white' : '#0C4212'; ?>">
        ...
        <!-- Orders -->
        <div class="flex items-center space-x-2 p-4 hover:bg-green-200 <?php echo ($module === 'orders') ? 'bg-green-900 text-white' : 'text-[#0C4212]'; ?>">
            <svg class="w-6 h-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="<?php echo ($module === 'orders') ? 'white' : '#0C4212'; ?>">
                <rect x="5" y="4" width="14" height="17" rx="2" stroke="<?php echo ($module === 'orders') ? 'white' : '#0C4212'; ?>" stroke-width="2"></rect>
                <path d="M9 9H15" stroke="<?php echo ($module === 'orders') ? 'white' : '#0C4212'; ?>" stroke-width="2" stroke-linecap="round"></path>
                <path d="M9 13H15" stroke="<?php echo ($module === 'orders') ? 'white' : '#0C4212'; ?>" stroke-width="2" stroke-linecap="round"></path>
                <path d="M9 17H13" stroke="<?php echo ($module === 'orders') ? 'white' : '#0C4212'; ?>" stroke-width="2" stroke-linecap="round"></path>
            </svg>
            <a href="../router/main.php?module=orders" class="ml-2 text-[20px]">Orders</a>
        </div>

        <!-- Vendors -->
        <div class="flex items-center space-x-2 p-4 hover:bg-green-200 <?php echo ($module === 'vendors') ? 'bg-green-900 text-white' : 'text-[#0C4212]'; ?>">
            <svg class="w-6 h-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="<?php echo ($module === 'vendors') ? 'white' : '#0C4212'; ?>">
                <path d="M14 22V16.9612C14 16.3537 13.7238 15.7791 13.2494 15.3995L11.5 14M11.5 14L13 7.5M11.5 14L10 13M13 7.5L11 7M13 7.5L15.0426 10.7681C15.3345 11.2352 15.8062 11.5612 16.3463 11.6693L18 12M10 13L11 7M10 13L9.40011 16.2994C9.18673 17.473 8.00015 18.2 6.85767 17.8573L4 17M11 7L8.10557 8.44721C7.428 8.786 7 9.47852 7 10.2361V12M14.5 3.5C14.5 4.05228 14.0523 4.5 13.5 4.5C12.9477 4.5 12.5 4.05228 12.5 3.5C12.5 2.94772 12.9477 2.5 13.5 2.5C14.0523 2.5 14.5 2.94772 14.5 3.5Z" stroke="<?php echo ($module === 'vendors') ? 'white' : '#0C4212'; ?>" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
            </svg>
            <a href="../router/main.php?module=vendors" class="ml-2 text-[20px]">Vendors</a>
        </div>

        <!-- Invoices -->
        <div class="flex items-center space-x-2 p-4 hover:bg-green-200 <?php echo ($module === 'invoices') ? 'bg-green-900 text-white' : 'text-[#0C4212]'; ?>">
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" fill="<?php echo ($module === 'invoices') ? 'white' : '#0C4212'; ?>">
    ...
    <div class="pb-6">
        <button type="button" class="flex ml-6 items-center space-x-2 text-green-900 font-semibold hover:text-red-300" id="logoutButton">
