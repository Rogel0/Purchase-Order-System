...
<aside class="flex flex-col justify-between w-70 border-r-2 border-gray-200 bg-[#E5E6EE] pl-8 pt-10" style="height: 90vh">
    ...
    <div class="space-y-2 pt-4">
        ...
        <!-- Home -->
        <div class="flex items-center space-x-2 p-4 <?php echo ($module === 'home') ? 'bg-green-900 text-white' : 'text-[#0C4212]'; ?>">
        ...
        <!-- Products -->
        <div class="flex items-center space-x-2 p-4 <?php echo ($module === 'products') ? 'bg-green-900 text-white' : 'text-[#0C4212]'; ?>">
        ...
        <!-- Orders -->
        <div class="flex items-center space-x-2 p-4 <?php echo ($module === 'orders') ? 'bg-green-900 text-white' : 'text-[#0C4212]'; ?>">
    ...
    <a href="../router/main.php?module=orders" class="ml-2 text-[20px]">Orders</a>
        ...
        <!-- Vendors -->
        <div class="flex items-center space-x-2 p-4 <?php echo ($module === 'vendors') ? 'bg-green-900 text-white' : 'text-[#0C4212]'; ?>">
    ...
    <a href="../router/main.php?module=vendors" class="ml-2 text-[20px]">Vendors</a>
        ...
        <!-- Invoices -->
        <div class="flex items-center space-x-2 p-4 <?php echo ($module === 'invoices') ? 'bg-green-900 text-white' : 'text-[#0C4212]'; ?>">
