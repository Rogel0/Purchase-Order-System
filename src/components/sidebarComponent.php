<aside class="flex flex-col justify-between w-70 border-r-2 border-gray-200 bg-[#EF984A] pl-8 pt-10" style="height: 88.1vh">
    ...
    <div class="space-y-2 pt-4">
        ...
        <a href="../router/main.php?module=dashboard" class="flex items-center space-x-2 p-4 hover:bg-[#E57785] <?php echo ($module === 'dashboard') ? 'bg-[#DF1A33] text-white' : 'text-[#000000]'; ?>">
            <svg class="w-6 h-6" fill="#000000" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" id="dashboard" class="icon glyph">
            ...
            <span class="ml-2 text-[20px]">Dashboard</span>
        </a>


        <!-- Products -->
        <a href="../router/main.php?module=products" class="flex items-center space-x-2 p-4 hover:bg-[#E57785] <?php echo ($module === 'products') ? 'bg-[#DF1A33] text-white' : 'text-[#000000]'; ?>">
            ...
            <span class="ml-2 text-[20px]">Products</span>
        </a>

        <!-- Orders -->
        <a href="../router/main.php?module=orders" class="flex items-center space-x-2 p-4 hover:bg-[#E57785] <?php echo ($module === 'orders') ? 'bg-[#DF1A33] text-white' : 'text-[#000000]'; ?>">
            ...
            <span class="ml-2 text-[20px]">Orders</span>
        </a>

        <!-- Vendors -->
        <a href="../router/main.php?module=vendors" class="flex items-center space-x-2 p-4 hover:bg-[#E57785] <?php echo ($module === 'vendors') ? 'bg-[#DF1A33] text-white' : 'text-[#000000]'; ?>">
        ...
        <!-- Invoices -->
        <a href="../router/main.php?module=invoices" class="flex items-center space-x-2 p-4 hover:bg-[#E57785] <?php echo ($module === 'invoices') ? 'bg-[#DF1A33] text-white' : 'text-[#000000]'; ?>">
