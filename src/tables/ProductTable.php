                ...
                <?php foreach ($addproducts as $product): ?>
                    <tr class="border-t text-sm text-center">
                        ...
                        <td class="px-6 py-4 flex items-center justify-center space-x-4">
                            <a href="#"
                                class="text-red-500 hover:scale-110 deleteProductBtn"
                                data-productid="<?php echo $product['product_number']; ?>">
...
<script>
    setupModal('delete-modal', '.deleteProductBtn', '#cancel-modal, #close-modal');
</script>