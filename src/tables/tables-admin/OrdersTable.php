                ...
                <?php foreach ($addorders as $order): ?>
                    <tr class="border-t text-sm text-center">
                        ...
                        <td class="px-6 py-4 flex items-center justify-center space-x-2">
                           <a href="#" data-order-id="<?php echo $order['po_number']; ?>" class="text-yellow-500 hover:scale-110 archiveOrderBtn">
                            ...
                            <button
                                data-target=".exampleModal-<?php echo htmlspecialchars($order['po_number']); ?>"
                                type="button"
                                class="viewOrderBtn text-red-500 hover:scale-110">
                    ...
                    <?php
                include('../modals/admin-viewing/orderView.php');
                ?>
                <?php endforeach; ?>
            <?php else: ?>
                <tr>
